...
//   const [cookieText, setCookieText] = useState("By clicking “Yes, I agree”, you agree to store cookies on your device and disclose information in accordance with our Cookie Policy.");
...
//         <div className="loyalty-point-section" id="cookie_setting_status_section">
//           <div className="form-group">
//             <label className="title-color d-flex" htmlFor="cookie_text">Cookie text</label>
//             <textarea
//               name="cookie_text"
//               id="cookie_text"
//               cols="30"
...
//             <button type="button" id="submit" className="btn px-5 btn--primary" onClick={handleSave}>
//               Save
//             </button>
//           </div>
//         </div>
...
import React, { useState } from "react";
import "./CookiesSettings.css"; // Ensure to have appropriate styles
