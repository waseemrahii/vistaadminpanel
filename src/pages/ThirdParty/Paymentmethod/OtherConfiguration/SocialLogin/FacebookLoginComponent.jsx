      ...
      >
        ...
        <div className="card-header">
          <div className="d-flex align-items-center gap-2">
            <img
              width="16"
              src="https://6valley.6amtech.com/public/assets/back-end/img/twitter-logo.png"
              alt=""
            />
          ...
          <label className="switcher">
            <input
              ...
              data-toggle-id="twitter-id"
              data-on-image="social/twitter-on.png"
              data-off-image="social/twitter-off.png"
              data-on-title="Want to turn ON Twitter login?"
              data-off-title="Want to turn OFF Twitter login?"
              data-on-message="<p>If enabled customers can log in to their account using their Twitter credentials</p>"
              data-off-message="<p>If disabled customers cannot log in to their account using their Twitter credentials</p>"
            />
