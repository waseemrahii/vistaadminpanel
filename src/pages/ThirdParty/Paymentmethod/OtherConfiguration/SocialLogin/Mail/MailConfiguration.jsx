            ...
            <div className="card-body pb-0">
              <div className="d-flex flex-wrap justify-content-between gap-3 border-bottom">
                <nav>
                  <div className="nav nav-tabs border-0" id="nav-tab" role="tablist">
                    <button className={`nav-link ${activeTab === 'mail-config' ? 'active' : ''}`} onClick={() => handleTabChange('mail-config')}>
                      Mail configuration
                    </button>
                    <button className={`nav-link ${activeTab === 'send-test-mail' ? 'active' : ''}`} onClick={() => handleTabChange('send-test-mail')}>
                      Send test mail
                    </button>
                  </div>
                </nav>
              ...
              <div className="tab-content">
                ...
                {activeTab === 'send-test-mail' && (
                  <div className="tab-pane fade show active" id="send-test-mail" role="tabpanel" aria-labelledby="send-test-mail-tab">
                    <div className="bg-white rounded-bottom overflow-hidden">
                      <div className="bg-white card-body">
                        <form className="" action="javascript:">
                          <div className="row">
