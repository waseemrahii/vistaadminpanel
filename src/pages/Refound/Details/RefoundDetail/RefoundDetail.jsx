...
//     const productName = refundData.order.products[0].name || "Default Product Name";
...
//                         <div className="card h-100 refund-details-card--2">
//                             <div className="card-body">
//                                 <h4 className="mb-3 text-capitalize">Note</h4>
//                                 <p className="text-muted">{refundData.note}</p>
//                             </div>
//                         </div>
//                     </div>
//                     <div className="col-sm-4">
//                         <div className="card h-100 refund-details-card--2">
//                             <div className="card-body">
//                                 <h4 className="mb-3 text-capitalize">Product details</h4>
//                                 <p className="text-muted">{refundData.order.products[0].description}</p>
//                             </div>
//                         </div>
//                     </div>
//                 </div>
